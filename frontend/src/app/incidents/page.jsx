...
export default function Page() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['incidents', pg],
    queryFn: async () => { const { data } = await api.get('/incidents?page=' + pg); return data; },
    retry: false,
  });
  const title = { projects:'Projects', fuel:'Fuel Logs', maintenance:'Maintenance', transfers:'Transfers', incidents:'Incidents' }['incidents'];
  const newHref = { projects:'/projects/new', fuel:'/fuel/new', maintenance:'/maintenance/job-cards/new', transfers:'/transfers/new', incidents:'/incidents/new' }['incidents'];
  return (
    <AppShell>
